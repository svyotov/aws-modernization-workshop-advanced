...
+
Step 2:: Close the `petstore-eks-manifest.yaml`. Run the following commands in the Cloud9 IDE `terminale` to replace the *[underline]#<YourAccountID>#* as well as *[underline]#<UserName>#* placeholders in the manifest file, with your AWS Account ID and unique AWS IAM 
User.
+
[source,shell]
----
