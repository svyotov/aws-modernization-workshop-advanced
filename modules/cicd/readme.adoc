...
+
Step 10:: In order to tell the function where to get the Demo Application docker image, enter `[red yellow-background]#<User Name>#-cicd-rep` as a lambda event parameter to our deployment lambda function.
+
